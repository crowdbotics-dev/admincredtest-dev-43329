...
## Project Structure
    ...
    ├── admincredtest_dev_43329  # Django project configurations
...
1. Clone this repo and `cd admincredtest_dev_43329`
...
2. Clone this repo and `cd admincredtest_dev_43329`
